/*
Nama Program : Pokedex CLI (Tahap Finalisasi)
Nama         : Kresna Bayu Wicaksono
NPM          : 140810230025
Tanggal Buat : 09 Desember 2025
Deskripsi    : Tahap 5 menyelesaikan program Pokedex CLI dengan fitur lengkap dan mengecek sinkronisasi fungsi:
               - Tambah Pokemon
               - Tampilkan Semua Pokemon
               - Urutkan Berdasarkan Power
               - Cari Pokemon (case-insensitive)
               - Filter Berdasarkan Tipe (single/dual)
               - Simpan ke File
               - Load dari File
               - Menu CLI interaktif
               Catatan perubahan dari Tahap 4:
               - Ditambahkan fungsi simpanFile() dan loadFile() menggunakan text file
               - Menu CLI lengkap menggunakan switch-case
               - Rencana awal simpan/load menggunakan binary, diganti text file agar lebih mudah dibaca dan debug
               - Semua fungsi sebelumnya tetap sama
*/

// Kode program persis sama seperti yang diberikan:
#include <iostream>
#include <fstream>
#include <string>
#include <iomanip>
